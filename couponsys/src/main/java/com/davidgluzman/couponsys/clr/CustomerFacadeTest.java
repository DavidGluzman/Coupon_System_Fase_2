...
//testing getAllCouponsByCategory()
		...
		TablesAndLinesUtils.printCouponsTable(customerFacade.getAllCouponsByCategory(Category.Sport), "testing getAllCouponsByCategory method (getting sport coupons) ");
	
//testing getAllCouponsByPriceLessThan()
		
		TablesAndLinesUtils.printCouponsTable(customerFacade.getAllCouponsByPriceLessThan(200), "testing getAllCouponsByPriceLessThan method (getting coupons that cost less than 200)");
		
//testing getCustomerDetails()
		
		TablesAndLinesUtils.printCustomersTable(Arrays.asList(customerFacade.getCustomerDetails()), "testing getCustomerDetails method (getting Moshes details)");
	}
