...
//
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCouponsByCategory(Category.Apparel),
//				"testing getAllCouponsByCategory method (apparel)");
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCouponsByCategory(Category.Sport),
//				"testing getAllCouponsByCategory method (sport)");
//
////testing getAllCouponsByPriceLessThan()
//
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCoupons(),
//				"all Abidas coupons before testing getAllCouponsByPriceLessThan method");
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCouponsByPriceLessThan(100),
//				"testing getAllCouponsByPriceLessThan method (coupons which price is less than 100)");
//
////testing getCompanyDetails()
//
//		TablesAndLinesUtils.printCompaniesTable(Arrays.asList(companyFacade.getCompanyDetails()),
//				"testing getCompanyDetails method (getting Abidas details)");
//
////testing deleteCoupon()
//
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCoupons(),
//				"testing deleteCoupon method (all Abidas coupons before deleting)");
//		companyFacade.deleteCoupon(6);
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCoupons(),
//				"testing deleteCoupon method (all Abidas coupons after deleting SALE)");
//		companyFacade.deleteCoupon(7);
//		TablesAndLinesUtils.printCouponsTable(companyFacade.getAllCoupons(),
//				"testing deleteCoupon method (all Abidas coupons after deleting GAME)");
//
//		TablesAndLinesUtils.printLine();
//
